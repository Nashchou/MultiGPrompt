...
parser.add_argument('--save_name', type=str, default='modelset/try.pkl', help='save ckpt name')
    ...
    for hid_units in list1:
        for a4 in lista4:
            ...
            for shotnum in range(1,2):
                ...
                for i in range(100):
                    idx_train = torch.load("data/fewshot_citeseer/{}-shot_citeseer/{}/idx.pt".format(shotnum,i)).type(torch.long).cuda()
                    pretrain_embs = embeds[0, idx_train]
                    train_lbls = torch.load("data/fewshot_citeseer/{}-shot_citeseer/{}/labels.pt".format(shotnum,i)).type(torch.long).squeeze().cuda()
                ...
                out = open("data/citeseer_fewshot.csv", "a", newline="")
